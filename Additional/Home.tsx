          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-6">
                <img 
                  src={hongKongPoster} 
                  alt="Walk-in Drive in Bangalore for Hong Kong" 
                  className="w-full h-auto rounded-lg mb-4 object-contain"
                  style={{ maxHeight: '400px' }}
                />
                <h3 className="text-xl font-semibold mb-2">
                  Walk-in Drive in Bangalore for Hong Kong
                </h3>
                <p className="text-muted-foreground mb-4">29-30 November 2024</p>
                <Button asChild className="w-full">
                  <Link to="/upload-resume">Apply Now</Link>
                </Button>
              </CardContent>
            </Card>
            {/* Add more poster cards here by duplicating the Card above */}
          </div>
        </div>
      </section>
